...
This tutorial will guide you in setting up R. Credits to the [original authors](https://github.com/rstudio/learnr/tree/master/inst/tutorials/ex-setup-r/ex-setup-r.Rmd).
